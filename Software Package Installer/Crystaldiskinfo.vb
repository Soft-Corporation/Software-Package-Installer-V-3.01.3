...
Public Class Crystaldiskinfo
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles Label6.Click
        ...
        Panel1.Hide()
        Timer1.Start()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_7677f37060e041c19069ef5c0046eed4.zip"), TextBox1.Text)
